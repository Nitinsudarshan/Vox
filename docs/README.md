...
| [benchmarks/PIPELINE_BASELINE.md](benchmarks/PIPELINE_BASELINE.md) | The Phase 1 meeting-transcription baseline: the pipeline's architecture, configuration, diagnostics and baseline performance, frozen as the point later refinements are measured against. |
| [benchmarks/TRANSCRIPTION_BENCHMARK_V1.md](benchmarks/TRANSCRIPTION_BENCHMARK_V1.md) | Generated by `tests/transcription/runner/run_benchmark.py` — regenerate it, never hand-edit it. Read [testing.md](testing.md)'s known gaps before quoting a number from it. |
| [benchmarks/TRANSCRIPTION_BENCHMARK_PUBLIC_V1.md](benchmarks/TRANSCRIPTION_BENCHMARK_PUBLIC_V1.md) | Generated by `tests/transcription/runner/run_public_benchmark.py` over the Common Voice and FLEURS manifests in `tests/transcription/public/`. |
...
Nothing is archived at present.
